...
function checkTypescriptIsInstalled() {
  try {
    ...
    console.error("It looks like you're trying to use TypeScript but do not have 'typescript' installed.");
    console.error("Please install 'typescript' by running 'npm install typescript'");
    process.exit(1);
  }
}
